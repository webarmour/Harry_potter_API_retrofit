...
import com.example.harry_potter_and_retrofit.presentation.ui.pagingfragment.PagingViewModel
...
//
//    @Provides
//    fun provideCachingDataWorkerFactory(
//        uploadCharacterListUseCase: UploadCharacterListUseCase,
//        cacheCharactersListUseCase: CacheCharactersListUseCase,
//    ): CachingDataWorkerFactory {
//        return CachingDataWorkerFactory(uploadCharacterListUseCase, cacheCharactersListUseCase)
//    }
//
//    @Provides
//    fun providePagingViewModel(getCharacterPagerUseCase: GetCharacterPagerUseCase): PagingViewModel {
//        return PagingViewModel(getCharacterPagerUseCase)
//    }
//
//    @Provides
//    fun providePagingViewModelFactory(pagingViewModel: PagingViewModel): PagingViewModelFactory {
